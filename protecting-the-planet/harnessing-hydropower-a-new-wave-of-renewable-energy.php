...
?>
<img src="img/hydropower.png" class="sectionBack">
...
<div class="column left flex">
    <div class="protecting-the-planet-page">
        ...
        <a href="http://www.rti.org" target="_blank"><img src="../img/RTI_w_1in.png" class="logo"></a>
            ...
            <p class="light">As climate change continues to pose a threat, curbing the use of fossil fuels is more important than ever. The world is experiencing the largest energy transformation since the Industrial Revolution, and hydropower has been a forefront in this&nbsp;revolution.</p>
        ...
        <div>
            ...
            <ul>
				...
				<li class="active"><!--<a href="harnessing-hydropower-a-new-wave-of-renewable-energy.php">-->Harnessing Hydropower: A New Wave of Renewable Energy<!--</a>--></li>
