...
?>
<img src="img/citizen-scientists.png" class="sectionBack">
...
<div class="column left flex">
    <div class="protecting-the-planet-page">
        ...
        <a href="http://www.rti.org"><img src="../img/RTI_w_1in.png" class="logo"></a>
            ...
            <p class="readmore"><a href="https://www.rti.org/impact/improving-nasa-satellite-data-low-cost-sensors" target="_blank">READ MORE</a></p>
        </div>
        <div>
            <p class="regular">Explore how we are protecting the planet through our work:</p>
            <ul>
                <li class="active"><!--<a href="enlisting-citizen-scientists-to-help-improve-air-quality.php">-->Enlisting Citizen Scientists to Help Improve Air Quality<!--</a>--></li>
