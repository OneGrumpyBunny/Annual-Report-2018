...
<div class="column ten flex">
    <div class="keeping-people-safe-page">
        ...
        <div>
			...
			<p class="light">In 2018, RTI launched a pilot study with Collaborative Health Solutions (CHS) to implement a blockchain-based solution to this problem. Blockchain is a data-storage system, distributed across a network of computers, that almost guarantees the privacy and integrity of information without being controlled by any one entity. That is to say, the records are highly resistant to being altered, lost, or accidentally deleted, which is why this system is the backbone of virtual currencies like Bitcoin</p>
            <p class="readmore"><a href="https://www.rti.org/impact/how-blockchain-can-help-victims-domestic-violence-california" target="_blank">READ MORE</a></p>
        </div>
		<div>
				...
				<ul>
					...
					<li class="active"><!--<a href="tackling-domestic-violence-with-technology.php">-->Tackling Domestic Violence with Technology<!--</a>--></li>
