...
<div class="column ten flex">
    <div class="enhancing-health-page">
        ...
        <div>
            ...
            <p class="light">RESEARCH TRIANGLE PARK, NC--Taxes on soft drinks, alcohol and tobacco are a powerful response to rising rates of non-communicable diseases (NCDs) worldwide, according to the most comprehensive analysis to date of evidence on expenditure, behaviour and socio-economic status, published in The Lancet.</p>
        ...
        <div>
            ...
            <li><a href="protecting-against-hiv-and-pregnancy-with-one-device.php">Protecting Against HIV and Pregnancy with One Device</a></li>
                ...
                <li class="active"><!---<a href="stemming-chronic-diseases-with-product-taxes.php">--->Stemming Chronic Diseases with Product Taxes?M<!---</a>---></li>
