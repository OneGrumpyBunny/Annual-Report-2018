...
<!-- mobile navigation -->
	<header>
		...
		<nav class="nav-total">
		<a href="<?php echo $REL_DIR ?>about-rti/" class="nav-link">
			...
			<a href="<?php echo $REL_DIR ?>enhancing-health-through-science-and-practice/" class="nav-link">
			...
			<a href="<?php echo $REL_DIR ?>keeping-people-safe/" class="nav-link">
			...
			<a href="<?php echo $REL_DIR ?>helping-regions-thrive-and-prosper/" class="nav-link">
			...
			<a href="<?php echo $REL_DIR ?>protecting-the-planet/" class="nav-link">
